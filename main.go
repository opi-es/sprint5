...
func (r Running) Calories() float64 {
	...
	return ((CaloriesMeanSpeedMultiplier*speed + CaloriesMeanSpeedShift) * r.Weight / MInKm * durationHours * MinInHours)
}
...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Weight + (math.Pow(speedMS, 2)/w.Height/CmInM)*CaloriesSpeedHeightMultiplier*w.Weight) * durationHours * MinInHours
}
...
func (s Swimming) Calories() float64 {
	...
	speed := s.meanSpeed()
	durationHours := s.Duration.Hours()
	return (speed + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * durationHours
}
